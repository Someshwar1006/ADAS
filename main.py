...
def handle_key_events():
    ...
    while True:
        ...
        if modes['Drive'] or modes['Reverse']:
...
def update_battery_display():
    if modes['Park']:
        battery_level = batteryPercentage()  # Get battery percentage from Park module
...
def periodic_update():
    ...
    root.after(5, periodic_update)  # Schedule the next update
